import { isString, readArgs, parseYaml } from './deps.ts'
...
const readConfig = (data: Record<string,unknown>) => ({
...
const readConfigFile = async (args: Record<string,unknown>): Promise<Record<string,string|undefined>> => {
...
const getConfig = async (args: Record<string,unknown>, id: string) => {
